...
const ACTION_CARDS = {
  ...
  DEFUSE: {
    type: 'DEFUSE',
    name: 'Catnip',
    blurb: 'Distract an Exploding Cat and sneak it back into the deck.',
    count: 6,
  },
  NOPE: {
    type: 'NOPE',
    name: 'Hiss',
    blurb: "Cancel another player's action. Hiss at a Hiss to undo it.",
    count: 5,
  },
  ATTACK: {
    type: 'ATTACK',
